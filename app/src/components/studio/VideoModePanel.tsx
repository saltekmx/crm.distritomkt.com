...
import { Film, Plus, GripVertical, ImageIcon, Loader2 } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col min-h-0 flex-1">
        <div className="px-3 py-2.5 border-b border-zinc-800/60 shrink-0 flex items-center gap-2">
          ...
          <span className="text-[10px] text-zinc-600 ml-auto">{pipelineVersions.length}</span>
        </div>
